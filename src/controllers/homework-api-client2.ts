...
export class HomeworkApiClient2 {
    static instance2: HomeworkApiClient2
    static number: HomeworkApiClient2
    ...
    public static async getInstance(request: APIRequestContext): Promise<HomeworkApiClient2> {
        if (!HomeworkApiClient2.instance2) {
            HomeworkApiClient2.instance2 = new HomeworkApiClient2(request)

        }
        return HomeworkApiClient2.instance2
    }
